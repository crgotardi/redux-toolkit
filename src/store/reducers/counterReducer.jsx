...
// listener middleware example
export const incrementAsyncListener = (startListening) => {
    startListening({
        actionCreator: incrementAsync.fulfilled,
        effect: async (action, listenerApi) => {
            console.log('effect action', action)
            console.log('effect listenerApi', listenerApi)
            alert('incremented')
        }
    })
}
